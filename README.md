...
## Server
**Стек:** node.js, 
Для запуск сервера необходимо установить зависимости командой **npm i**, затем запустить сервер командой **npm start**
...
Количесвто строк в таблице при инициализации сервера:
```
...
Для запуск клиента необходимо установить зависимости командой **npm i**, затем запустить клиент командой **npm start**
...
При подключении клиента сервер отправлять клиенту массив действий над таблицей в формате JSON.
